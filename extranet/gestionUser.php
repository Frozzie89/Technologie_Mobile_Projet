...
<div class="container">
    <div class="md-form mt-0">
        <input class="form-control" type="text" placeholder="Rechercher un utilisateur par son pseudonyme ou son adresse mail"
    ...
    <div class="container border" style="background-color: white;">
        <table class="table">
            ...
            <tbody id="userTable">
                ...
                <tr>
                    <td id="emailUser" <?php if ($isAdmin != false ) echo "style=\"color:green;\""; ?>><?= $user->login_membres ?></td>
                    <td id="pseudoUser" <?php if ($isAdmin != false ) echo "style=\"color:green;\""; ?>><?= $user->pseudo_membres ?></td>
                    <td><?php if (!$isAdmin) echo "<a class=\"deleteUser\" id=\"$user->id_membres\" href=\"#\">supprimer</a>"; ?></td>
                </tr>
                <?php endforeach;?>
            </tbody>
        </table>
